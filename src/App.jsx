...
export default function App() {
  ...
  const sessionsData = [
    ...
    { type: 'talk', name: 'Dr. Divyasree', affiliation: 'IISER Pune', institution: 'IISER Pune', website: 'https://sites.google.com/view/divyasreecr/home', talkTitle: 'Zero-Cycles on Twisted Grassmannians', abstract: `The first systematic study of zero-cycles on projective homogeneous varieties was carried out by Krashen in 2010, where he proved the triviality of the group $A_0(X)$ of degree-zero zero-cycles for many projective homogeneous varieties of the classical groups, with subsequent generalizations by Chernousov and Merkurjev. In this talk, we study zero-cycles on generalized Severi–Brauer varieties, which are twisted forms of Grassmannians. Let $A$ be a central simple algebra over a field $F$ of index $n$, and let $SB_r(A)$ be the $r$-th generalized Severi–Brauer variety. We prove that $A_0(SB_r(A))$ is $(d,n/d)$-torsion, where $d=(r,n)$, and obtain new cases in which $A_0(SB_r(A))=0$. We also show that $A_0(SB_r(A))=0$ when $F$ is a local or global field.`, day: 'Thursday, September 17, 2026', time: '5:30 – 6:00 PM', venue: 'AB1 316 (Third Floor)' },
